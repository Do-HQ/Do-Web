...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "text-foreground h-9 px-2 text-left align-middle text-[12.5px] font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className,
      )}
      {...props}
    />
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn("text-muted-foreground mt-3 text-[12.5px]", className)}
      {...props}
    />
  );
}
