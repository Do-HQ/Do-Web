...
const WorkspaceArchive = () => {
  ...
  const isWorkflowLoading =
    ...
    archivedWorkflowQueries.some((query) => query.isLoading || query.isFetching);
  ...
  return (
    <div className="mx-auto flex h-full min-h-0 w-full max-w-6xl flex-1 flex-col gap-3 p-4 md:p-6">
      <div className="bg-muted/15 ring-border/35 relative overflow-hidden rounded-2xl p-3 ring-1 md:p-4">
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block text-[13px] font-semibold">{count}</span>
                </span>
                <span className={cn("size-1.5 rounded-full", meta.accentClassName)} />
              </button>
            );
          })}
        </div>
      ...
      >
        <TabsList className="bg-muted/25 ring-border/35 h-10 w-full justify-start overflow-x-auto rounded-xl p-1 ring-1">
          {(Object.keys(ARCHIVE_TAB_META) as ArchiveTab[]).map((tabKey) => {
            const meta = ARCHIVE_TAB_META[tabKey];
            const Icon = meta.icon;
            const count =
        ...
        <TabsContent value="projects" className="min-h-0 flex-1">
          <ArchiveSection
            ...
            actionDisabled={
              !archivedProjects.length || !workspacePermissions.canArchiveProjects
            }
        ...
        <TabsContent value="workflows" className="min-h-0 flex-1">
          <ArchiveSection
            ...
            actionLabel="Restore all visible"
            actionDisabled={
              !archivedWorkflows.length || !workspacePermissions.canArchiveProjects
            }
        ...
        <TabsContent value="teams" className="min-h-0 flex-1">
          <ArchiveSection
            ...
            actionLabel="Restore all visible"
            actionDisabled={!archivedTeams.length || !workspacePermissions.isAdminLike}
...
function ArchiveSection({
  ...
  return (
    <div className="bg-muted/15 ring-border/35 relative min-h-0 overflow-hidden rounded-xl p-3 ring-1 md:p-4">
      <span
        className={cn("absolute top-0 left-0 h-full w-1 opacity-65", accentClassName)}
      />
