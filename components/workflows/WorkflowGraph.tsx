...
export function WorkflowGraph({
  ...
  const completedNodes = workflows.filter(
    (workflow) => workflow.progress >= 100,
  ).length;
  ...
  return (
    <div className="rounded-xl border border-border/20 bg-background/80 p-2.5">
      ...
      <div className="overflow-x-auto scrollbar-hide snap-x snap-mandatory scroll-smooth  pb-1">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={cn(
                        "w-52 rounded-xl border border-border/15 p-2 text-left outline-none transition-colors hover:bg-card focus-visible:outline-none snap-start",
                        active
                    ...
                    <div className="space-y-1.5 ">
                      ...
                      <div className="space-y-1 text-muted-foreground flex items-center gap-2 flex-wrap">
                        ...
                        <p className="inline-flex items-center gap-1">
                          ...
                          Teams:{" "}
                          {workflow.teams.join(", ") || "No team assigned"}
                        </p>
                      </div>
                    </div>
                  </TooltipContent>
