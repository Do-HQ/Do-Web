...
const CommandSearch = () => {
  ...
  const navigationItems = React.useMemo<QuickActionItem[]>(
    () => [
      ...
      },
      {
        ...
        label: "Reports",
        icon: FileText,
        onSelect: () => closeAndRoute(ROUTES.REPORTS),
      },
      {
        id: "nav-report-schedules",
        label: "Report schedules",
        icon: Clock3,
        onSelect: () => closeAndRoute(ROUTES.SETTINGS_REPORTS),
      },
      {
        id: "nav-standups",
        label: "Standups",
        icon: ClipboardCheck,
        onSelect: () => closeAndRoute(ROUTES.STANDUPS),
      },
      {
        id: "nav-my-standup",
        label: "My standup",
        icon: ClipboardCheck,
        onSelect: () => closeAndRoute(ROUTES.STANDUP),
      },
      {
        id: "nav-templates",
        label: "Templates",
  ...
  const routeResults = React.useMemo<SearchResultItem[]>(() => {
    ...
    const pageResults: SearchResultItem[] = [
      ...
      {
        id: "route:standup-settings",
        label: "Standup settings",
        href: ROUTES.SETTINGS_STANDUP,
        icon: ClipboardCheck,
        hint: "Settings",
      },
      {
