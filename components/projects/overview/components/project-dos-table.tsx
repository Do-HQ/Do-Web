                  ...
                  <Fragment key={task.id}>
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          ...
                          <div
                            className={cn("text-[11px]", taskTone.textClass)}
                          >
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          >
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                onEditTask(task.workflowId, task.id)
                              }
                            >
                              <Pencil />
                              Edit task
                            ...
                            {onCreateSubtask ? (
                              <DropdownMenuItem
                                onClick={() =>
                                  onCreateSubtask(task.workflowId, task.id)
                                }
                              >
                                <Plus />
                                Add subtask
                    ...
                    {isExpanded
                      ? task.subtasks.map((subtask) => {
                          const subtaskAssignee = resolveMemberById(
                            members,
                            subtask.assigneeId,
                          );
                          const subtaskProgress = getTaskRowProgress({
                          ...
                          return (
                            <TableRow
                              key={subtask.id}
                              className="bg-muted/8 h-8 [&>td]:py-1.5"
                            >
                              <TableCell>
                              ...
                              <TableCell>
                                {subtaskAssignee?.name ?? "Unassigned"}
                              </TableCell>
                              <TableCell>{team?.name ?? "Inherited"}</TableCell>
                              <TableCell>
                                <Badge
                                  variant="outline"
                                  className={STATUS_STYLES[subtask.status]}
                                >
